...
colors = [["#464660", "#464660"], # panel background            #0
          ["#57CC99", "#57CC99"], # Underline boi               #1
          ["#7197E7", "#7197E7"], # color for the clock         #2
          ["#F3F1F5", "#F3F1F5"], # Group foreground            #3
          ["#A77AC4", "#A77AC4"], # Color for Battery           #4
          ["#000000", "#000000"], # Foreground for the widgets  #5
          ["#7197E7", "#7197E7"], # Layout widget color         #6
          ["#393E46", "#393E46"], # Group Background color      #7
          ]
